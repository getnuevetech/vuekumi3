...
2. **[01-IMPLEMENTATION-PLAN.md](./01-IMPLEMENTATION-PLAN.md)** — living execution plan:
   shipped Phases 0–52 (Arcs A–D complete; through Phase 52 / T4 `/rights` hub).
...
5. **[07-TRUST-RIGHTS-COMPENSATION-COUNTRY-PLAN.md](./07-TRUST-RIGHTS-COMPENSATION-COUNTRY-PLAN.md)** —
   ...
   compensation negotiation, Country Activation Matrix admin. T0–T2 + T4 foundations
   shipped (Phases 49–52); remainder plan until approved.
6. **[08-ADMIN-PORTAL-ENGINEERING-SPEC.md](./08-ADMIN-PORTAL-ENGINEERING-SPEC.md)** —
   ...
   **P0 (Phase 49) shipped**; T1–T2 + T4 (Phases 50–52) shipped; P1–P2 remain plan until approved.
