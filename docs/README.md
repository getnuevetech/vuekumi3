...
2. **[01-IMPLEMENTATION-PLAN.md](./01-IMPLEMENTATION-PLAN.md)** — living execution plan:
   shipped Phases 0–53 (Arcs A–D complete; through Phase 53 / T7 country matrix ops).
...
6. **[08-ADMIN-PORTAL-ENGINEERING-SPEC.md](./08-ADMIN-PORTAL-ENGINEERING-SPEC.md)** —
   ...
   **P0 (Phase 49) shipped**; T1–T2 + T4 + T7 (Phases 50–53) shipped; P1–P2 remain plan until approved.
