...
export const photos: Photo[] = [
  ...
  { id: 'afr-030', src: `${P}/people-lagos-portrait.jpg`, title: 'Lagos Window Light', category: 'People', country: 'Nigeria', photographer: 'amara-okafor', license: 'premium', price: 14, downloads: 860, views: 4200, likes: 310, tags: ['portrait', 'lagos', 'woman', 'editorial'] },
  { id: 'afr-031', src: `${P}/wildlife-savanna-lion.jpg`, title: 'Lion in the Long Grass', category: 'Wildlife', country: 'Kenya', photographer: 'lekan-adeyemi', license: 'premium', price: 16, downloads: 1240, views: 6800, likes: 540, tags: ['lion', 'savanna', 'wildlife', 'kenya'] },
  { id: 'afr-032', src: `${P}/landscape-rift-escarpment.jpg`, title: 'Rift Escarpment', category: 'Landscape', country: 'Ethiopia', photographer: 'selam-tesfaye', license: 'free', price: 0, downloads: 980, views: 5100, likes: 290, tags: ['escarpment', 'rift', 'highlands', 'landscape'] },
  { id: 'afr-033', src: `${P}/urban-accra-street.jpg`, title: 'Accra After Rain', category: 'Urban', country: 'Ghana', photographer: 'kofi-mensah', license: 'free', price: 0, downloads: 740, views: 3600, likes: 210, tags: ['accra', 'street', 'city', 'urban'] },
  { id: 'afr-034', src: `${P}/culture-drum-circle.jpg`, title: 'Drum Circle at Dusk', category: 'Culture', country: 'Senegal', photographer: 'amara-okafor', license: 'premium', price: 12, downloads: 640, views: 2900, likes: 240, tags: ['drum', 'portrait', 'culture', 'music'] },
  { id: 'afr-035', src: `${P}/craft-kente-weave.jpg`, title: 'Kente on the Loom', category: 'Food & Craft', country: 'Ghana', photographer: 'kofi-mensah', license: 'free', price: 0, downloads: 810, views: 4100, likes: 260, tags: ['kente', 'weave', 'craft', 'textile'] },
